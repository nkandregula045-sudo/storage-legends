-- Storage Legends Item Database
-- Define all items that can be found in storage units
...
ItemData.RetroCollection = {
    ...
    CompletionBonus = { Type = "SellValueMultiplier", Value = 1.05 }, -- +5%
}
...
ItemData.LuxuryCollection = {
    ...
    CompletionBonus = { Type = "LuckMultiplier", Value = 1.10 }, -- +10%
}
...
ItemData.GamingCollection = {
    ...
    CompletionBonus = { Type = "ValueMultiplier", Value = 1.07 }, -- +7%
}

-- COLLECTIBLE ITEMS (can appear in any storage)
ItemData.AllItems = {
    -- Retro
